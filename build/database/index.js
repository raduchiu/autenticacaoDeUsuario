...
class Database {
  ...
  init() {
    ...
    this.connection = process.env.NODE_ENV === 'development' ? new (0, _sequelize2.default)(_database2.default) :
      new (0, _sequelize2.default)(process.env.DATABASE_URL, _database2.default);
